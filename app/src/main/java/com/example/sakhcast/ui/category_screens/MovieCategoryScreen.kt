...
fun MovieCategoryScreen(
    ...
    moviesCategoryScreenState: MovieCategoryScreenViewModel.MoviesCategoryScreenState
) {
    val categoryName = moviesCategoryScreenState.categoryName
    val movieList = moviesCategoryScreenState.moviesList
    Column {
